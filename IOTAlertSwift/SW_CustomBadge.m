...
- (void) autoBadgeSizeWithString:(NSString *)badgeString
{
    ...
    CGSize size = [badgeString sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"HelveticaNeue-Light" size:12]}];
...
- (void)drawRect:(CGRect)rect {
    ...
    if ([self.badgeText length]>0) {
        ...
        //UIFont *textFont = [UIFont fontWithName:@"HelveticaNeue-Light" size:sizeOfFont];
