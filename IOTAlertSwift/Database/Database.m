...
NSString * const DataBaseName  = @"IOTAlert.sqlite"; // Paas Your DataBase Name Over here
...
-(BOOL) createEditableCopyOfDatabaseIfNeeded
{
    ...
    //[fileManager addSkipBackupAttributeToItemAtURL:[NSURL fileURLWithPath:writableDBPath]];
    return success;
}
